...
export default function TeamRecruitPage() {
  ...
  const teamRecruits: TeamRecruitment[] = [ 
    { 
      ...
      positions: ['프론트엔드', '백엔드'], 
      tags: ['React', 'Next.js', 'TypeScript', '스터디'], 
      postedAt: '2024-11-28', 
      postedBy: '김개발', 
      status: '모집중', 
      likes: 24, 
    ...
    { 
      id: 2, 
      teamName: '오픈소스 컨트리뷰션 팀', 
      title: 'Hacktoberfest 함께 참여하실 분 구합니다', 
      positions: ['프론트엔드', '백엔드', 'DevOps'], 
      tags: ['오픈소스', 'Git', 'GitHub', '프로젝트'], 
      postedAt: '2024-11-27', 
      postedBy: '이코드', 
      status: '모집중', 
      likes: 45, 
    ...
    { 
      id: 3, 
      teamName: 'AI 연구 동아리', 
      title: '머신러닝 스터디원 모집 (초보 환영)', 
      positions: ['AI/ML'], 
      tags: ['Python', 'TensorFlow', 'PyTorch', '머신러닝'], 
      postedAt: '2024-11-25', 
      postedBy: '박연구', 
      status: '마감', 
      likes: 67, 
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 sm:px-6 py-8 w-full">
      ...
      {activeTab === '게시판' && <TeamRecruitTab recruits={teamRecruits} searchQuery={searchQuery} />}
