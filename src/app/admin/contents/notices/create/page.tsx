    ...
    <div className="p-4 md:p-8">
      <div className="mx-auto max-w-3xl">
        ...
        <div className="mb-8">
          ...
          <h1 className="mb-2 text-3xl font-bold text-gray-900">공지사항 작성</h1>
            ...
            <div>
              ...
              <div className="mb-3 flex gap-2">
                ...
                <button
                  ...
                  className="flex items-center gap-2 rounded-lg bg-gray-100 px-4 py-2.5 font-medium text-gray-700 transition-colors hover:bg-gray-200"
                  disabled={submitting}
                >
